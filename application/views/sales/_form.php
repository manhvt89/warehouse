...
<?php echo form_open("sales/ajax_save_info/".$sale_info['sale_uuid'], array('id'=>'sales_edit_form', 'class'=>'form-horizontal')); ?>
	<fieldset id="sale_basic_info">
		<div class="form-group form-group-sm">
			...
			<?php echo anchor('sales/receipt/'.$sale_info['sale_uuid'], '' . $sale_info['code'], array('target'=>'_blank', 'class'=>'control-label col-xs-8', "style"=>"text-align:left"));?>
		</div>
