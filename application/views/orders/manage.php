...
$(document).ready(function()
{
	...
	$('#daterangepicker').data('daterangepicker').setStartDate("<?php echo date($this->config->item('dateformat'), mktime(0,0,0,$m,01,$y));?>");
	var start_date = "<?php echo date('Y-m-d', mktime(0,0,0,$m,01,$y));?>";
...
<div id="title_bar" class="print_hide btn-toolbar">
	...
	<?php echo anchor("order", '<span class="glyphicon glyphicon-shopping-cart">&nbsp</span>' . $this->lang->line('order_register'), array('class'=>'btn btn-info btn-sm pull-right', 'id'=>'show_sales_button')); ?>
</div>
