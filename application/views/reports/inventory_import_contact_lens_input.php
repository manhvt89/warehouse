...
$(document).ready(function()
{
	...
	$("#generate_report").click(function()
	{
		...
		$.ajax({
			method: "POST",
			url: "<?php echo site_url('reports/ajax_inventory_import_contact_lens')?>",
			...
			.done(function( msg ) {
				if(msg.result == 1)
				{
					...
					if(msg.data.category == 'Bách Quang') {
						...
						var header_rp = '<tr class="heder_table_contact_len"><td>STT</td><td>Tên hàng</td>' +
						...
						for (var key in maxim1day) {
							html_maxim1day = html_maxim1day + '<tr class="chilrent"><td></td><td style="padding-left: 10px; text-align: left;">' + key + '</td>';
							for (i = 1; i < 34; i++) {
					...
					else if(msg.data.category == 'Seed')
					{
						...
						html_fr1day = '<tr class="root"><td>3</td><td style="text-align: left">SEED 1 DAY</td>';
						for (i = 1; i < 34; i++) {
