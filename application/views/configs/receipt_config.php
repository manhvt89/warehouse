<?php echo form_open('config/save_receipt/', array('id' => 'receipt_config_form', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_precription_printer'), 'config_precription_printer', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_dropdown('precription_printer',	array(), ' ', 'id="precription_printer" class="form-control"'); ?>
				</div>
			</div>
...
$(document).ready(function()
{
	if (window.localStorage && window.jsPrintSetup) 
	{
		...
		$('#receipt_printer, #invoice_printer, #takings_printer, #precription_printer').each(function()
		{
			var $this = $(this)
