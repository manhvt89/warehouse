...
<table id="items_count_details" class="table table-striped table-hover">
	<thead>
		<tr style="background-color: #999 !important;">
			<th colspan="4"><?php echo $this->lang->line('inventory_data_tracking'); ?></th>
		</tr>
		<tr>
			<th width="30%"><?php echo $this->lang->line('item_tracking_date'); ?></th>
			<th width="20%"><?php echo $this->lang->line('item_employee'); ?></th>
			<th width="20%"><?php echo $this->lang->line('item_in_out_qty'); ?></th>
			<th width="30%"><?php echo $this->lang->line('item_remarks'); ?></th>
		</tr>
	</thead>
	<tbody id="inventory_result">
		...
		*/
		...
		foreach($inventory_array as $row)
		{
			...
			array_push($employee_name, $employee->last_name . ' ' . $employee->first_name);
		}
		?>
	</tbody>
</table>
