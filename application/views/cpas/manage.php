...
$(document).ready(function()
{
    ...
    event.stopPropagation(); // Chặn event bubble
    console.log('Print button clicked'); // Kiểm tra log
    window.print();
});
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer print_hide">
        ...
        <button type="button" class="btn btn-primary" id="approveButton">Phê duyệt</button>
      </div>
    </div>
  </div>
</div>
